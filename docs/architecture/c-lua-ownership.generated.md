...
flowchart LR
    ...
    n_object_timer_queue["Object timer queue and callbacks<br/>partial"]
...
| C and Lua level construction | partial | js/mklev.js<br/>js/weight.js<br/>js/dungeon.js<br/>js/lua_des.js<br/>js/regions.js<br/>js/monmove.js<br/>js/light.js<br/>js/object_timers.js<br/>js/vision.js<br/>js/allmain.js | fastforward.mineralize<br/>seeded room-fill compatibility paths | The ordinary-room orchestration and exact 31-name themed-room dispatch now have direct witnesses; Ghost, Cloud, Boulder, Spider, Garden, Trap, Massacre, and Statuary fills are live source callbacks. Buried treasure now reaches ordered ROT_ORGANIC/ROT_CORPSE callbacks, Buried zombies reaches ordered revival/failure/fill-pit callbacks, and Light source shares that queue, but all three remain partial at their explicitly listed lifecycle gaps. Exact source ordering across all shapes, seven incomplete fill callbacks, many special-level operations, legacy seeded generation branches, incomplete monster/trap/special-object constructors, and a sealed gate remain open. |
| Object timer queue and callbacks | partial | js/object_timers.js<br/>js/allmain.js<br/>js/mklev.js<br/>js/light.js | none | The live queue owns saveable per-object timers, source deadline ordering, newest-first equal-deadline ordering, claim-before-callback semantics, and four callback kinds. HATCH_EGG, FIG_TRANSFORM, SHRINK_GLOB, MELT_ICE_AWAY, non-oil BURN_OBJECT variants, timer move/split/relink semantics, exact pre-registry save tie reconstruction, inactive cached-level timers, complete inventory/worn corpse effects, and a sealed gate remain open. |
