...
| Hero, monster, and global-turn scheduler | partial | js/allmain.js<br/>js/monmove.js | fastforward.turn<br/>fastforward.ranger-turn<br/>scheduler.default-replay-gap<br/>seeded role replay modules | Actor-rich role paths still enter seeded scheduler replay or fail loudly in bridge-free mode. |
| Samurai pet turns, altar run, and prayer occupation | partial | js/allmain.js<br/>js/monmove.js<br/>js/pray.js | samurai.altar-run-prayer<br/>bounded Samurai compatibility cadence | Native dog_move phases are collapsed across the altar run and prayer occupation. |
| Rogue and Rogue-Orc actor scheduling | partial | js/allmain.js<br/>js/monmove.js<br/>js/rogue_explore.js<br/>js/rogue_orc.js<br/>js/rogue_friday13.js | rogue.explore<br/>rogue.friday13<br/>rogue.orc<br/>rogue.chargen<br/>seeded-replay.rogue-explore<br/>seeded-replay.rogue-orc<br/>seeded-replay.rogue-friday13 | Named Rogue runs still replay aggregate actor turns instead of scheduling live fmon and dog_move phases. |
