...
| C and Lua level construction | Fill: Light source | partial | The initialized lit oil lamp plus the shared oil-lamp/brass-lantern source fuel breakpoints, saveable deadline state, ordered generic timer dispatch, exact and overdue expiration, surviving-lantern identity, and radius-three mobile illumination have direct zero-bridge witnesses. Threshold warning text, lamp command activation and extinguishing, potions of oil, candles, the candelabrum, artifact light, other cleanup/reschedule variants, inactive cached-level timing, and a sealed stratum remain open. |
