...
| Live monster inventory acquisition and pet release | partial | js/monster_inventory.js<br/>js/cmd.js<br/>js/monmove.js | none | Unicorn gem acceptance, ordinary pet pickup/release, exact-square covetous artifact pickup, bullwhip inventory snatch, and clone-Wizard fake-Amulet linkage now use the common source-shaped boundaries. Stack merging and the generic swallowed-throw transaction, including its supported lamp snuffing, are tracked separately. Swallowed damaging or consuming objects, other thrown or kicked catches, shopkeeper projectile snatches, quest-leader retention, monster container rummaging, polymorph transfers, knowledge loss, non-swallowed light snuffing and candle burn, equipment continuation, migration persistence, and a sealed stratum remain open. |
| Generic swallowed throw contact and acquisition | partial | js/swallowed_throw.js<br/>js/cmd.js<br/>js/monster_inventory.js<br/>js/object_merge.js<br/>js/figurine_timer.js<br/>js/light.js<br/>js/object_timers.js<br/>js/senses.js<br/>js/vision.js | none | The non-worn, paid, generic non-consuming object path is live from selector and direction through split/free ownership, slip and hit-roll cadence, wake/contact prose, LOST_THROWN-to-LOST_STOLEN repair, carrying effects, timer replacement, minvent insertion, and compatible-stack absorption. Lit oil lamps, brass lanterns, and magic lamps additionally own the sighted/blind mpickobj message gate, link-before-snuff ordering, BURN_OBJECT cancellation, unused-fuel restoration, and mobile-light invalidation. Weapons and weapon-tools, gems, gold, food and taming, potions, eggs/pies/venom, boulders and iron balls, attached or worn objects, unsupported burning objects and artifact lights, shop billing, petrifying corpses, low-stamina drops, timed stack splitting, returning missiles, engulfer death, complete naming variants, and a sealed stratum remain open. |
