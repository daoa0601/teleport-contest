...
| Thrown object split and inventory detachment | partial | js/thrown_object.js<br/>js/swallowed_throw.js<br/>js/potion_throw.js<br/>js/cmd.js | throw.swallowed-weapon-unsupported<br/>throw.swallowed-special-unsupported<br/>throw.potion-impact-unsupported | One shared helper owns timerless singleton freeinv and timerless stack split for the represented swallowed and ordinary potion callers. Worn and ready-state unwinding, split timer replication, unpaid and billed identities, container links, punishment objects, multishot bookkeeping, split/unsplit return paths, every older duplicated caller, and a sealed stratum remain open. |
| Generic swallowed throw contact and acquisition | partial | js/swallowed_throw.js<br/>js/thrown_object.js<br/>js/cmd.js<br/>js/potion_hit.js<br/>js/projectile.js<br/>js/weapon_damage.js<br/>js/skills.js<br/>js/attrib.js<br/>js/monster_inventory.js<br/>js/object_merge.js<br/>js/figurine_timer.js<br/>js/light.js<br/>js/object_timers.js<br/>js/senses.js<br/>js/vision.js<br/>js/end.js<br/>js/exper.js<br/>js/display.js | throw.swallowed-weapon-unsupported<br/>throw.swallowed-special-unsupported<br/>throw.potion-impact-unsupported | The non-worn, paid, generic non-consuming object path is live from selector and direction through split/free ownership, slip and hit-roll cadence, wake/contact prose, LOST_THROWN-to-LOST_STOLEN repair, carrying effects, timer replacement, source-head minvent insertion, and compatible-stack absorption. Lit oil lamps, brass lanterns, and magic lamps additionally own link-before-snuff and burn cleanup. Ordinary hard-material non-ammo weapons, weapon-tools, and a single weapon-class missile or ammunition identity own live damage and survivor continuations. Six inert and five healing/ability potion types own swallowed guaranteed contact, while ordinary map flight is tracked separately. The ordinary room death slice owns xkilled narration, killing-object acquisition, swallowed-state release/redraw/cooldown, head-first relobj, corpse and extra-drop suppression, same-square autopickup/look_here, experience, and alignment cleanup with empty or ordinary weapon/scroll prior inventory, including compatible stack absorption. Multishot and multigen stacks, gem/sling ammo, boomerangs/returning weapons, silver/blessed/poison/artifact and target-specific modifiers, axes, peaceful/pet/worm carriers, worn weapons, shop state, gold, food/taming, sickness and the remaining potion families, eggs/pies/venom, boulders and iron balls, attached objects, unsupported lights, low-stamina drops, timed splitting, life-saving and other special deaths, special carried effects, non-room terrain/traps/shops/punishment, complete naming variants, and a sealed stratum remain open. Every unresolved swallowed class now reaches a named compatibility bridge instead of ordinary floor logic. |
| Monster potion impact and supported vapor effects | partial | js/potion_hit.js<br/>js/potion_throw.js<br/>js/thrown_object.js<br/>js/swallowed_throw.js<br/>js/cmd.js<br/>js/monmove.js | throw.potion-impact-unsupported | Six inert types plus gain ability, restore ability, healing, extra healing, and full healing use the shared impact owner for swallowed guaranteed contact and ordinary sighted, unencumbered ROOM/CORR/open-DOOR map flight against ordinary hostile targets. The healing family owns direct monster heal/blindness state, Pestilence inversion, non-anger wake policy, proximity and nearby-break vapor, hero and polymorph HP fallthrough, blind/deaf cure, Constitution exercise, ordered ability restoration, breathless/eyeless presentation, and damp-towel shielding. Cursed or greased map throws, blind or burdened heroes, air/levitation/underwater flight, traps and special terrain, peaceful/tame/unique/special live map targets, sickness and other potion families, hero impact targets, resistance and special target effects, equipment and saddle state, shop billing, interactive trycall naming, complete visibility variants, and a sealed stratum remain open. Lua owns none of this runtime path. |
| Physical weapon damage dice, enchantment, erosion, and Strength | partial | js/weapon_damage.js<br/>js/swallowed_throw.js<br/>js/cmd.js | none | The ordinary physical damage table, enchantment, erosion, and Strength bonus core are shared, and swallowed guaranteed-survivor weapon plus projectile callers compose live launcher/weapon skill damage, Strength selection, and training. Target-specific blessed, silver, wooden, artifact-light, shade, thick-hide, axe, poison, and special-monster modifiers are deliberately excluded; melee and several map projectile callers still retain partial duplicated damage ownership, and no sealed stratum has run. |
| Projectile mulching and passive-object effects after a hit | partial | js/projectile.js<br/>js/swallowed_throw.js<br/>js/cmd.js | throw.swallowed-weapon-unsupported | Hero-thrown ordinary ammunition and missiles now share one source-shaped mulch/free and fire, acid, rust, corrosion, or enchantment passive-object owner across map and swallowed callers. The swallowed continuation directly owns one weapon-class identity and correctly bypasses mulch/passive after the ordinary killing continuation acquires and disposes of it. Multishot and multigen stacks, gem/sling swallowed ammo, boomerangs, monster-moving blessed mulch, poison, silver/blessed target damage, artifact/special projectiles, complex projectile-caused engulfer deaths, broader passive materials and carried presentation, shop billing, and a sealed stratum remain open. |
