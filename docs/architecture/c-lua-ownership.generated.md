...
| C and Lua level construction | partial | js/mklev.js<br/>js/weight.js<br/>js/dungeon.js<br/>js/lua_des.js | fastforward.mineralize<br/>seeded room-fill compatibility paths | The ordinary-room orchestration and exact 31-name themed-room dispatch now have direct witnesses, and Ghost of an Adventurer no longer depends on a replay carrier. Exact source ordering across all shapes, fourteen incomplete fill callbacks, many special-level operations, legacy seeded generation branches, incomplete monster/trap/special-object constructors, and a sealed gate remain open. |
...
| C and Lua level construction | Fill: Cloud room | absent | Fog-cloud population and gas-cloud selection are not ported. |
| C and Lua level construction | Fill: Boulder room | absent | Filtered boulder versus rolling-boulder-trap callbacks are not ported. |
| C and Lua level construction | Fill: Spider nest | absent | Filtered web construction and depth-sensitive spider placement are not ported. |
| C and Lua level construction | Fill: Trap room | absent | Trap reservoir shuffle and filtered placement are not ported. |
| C and Lua level construction | Fill: Garden | absent | Nymph/fountain callbacks and deferred wall transformation are not ported. |
| C and Lua level construction | Fill: Buried treasure | absent | Buried chest contents and deferred engraving marker are not ported. |
| C and Lua level construction | Fill: Buried zombies | partial | Base corpse burial exists; depth-expanded species, timer ownership, and exact source ordering need completion. |
| C and Lua level construction | Fill: Massacre | absent | Role-corpse reservoir and repeated construction are not ported. |
| C and Lua level construction | Fill: Statuary | absent | Statue population and statue-trap loop are not ported. |
| C and Lua level construction | Fill: Light source | absent | Lit oil-lamp construction is not ported. |
