...
flowchart LR
    ...
    n_timed_lamp_application["Oil-lamp and brass-lantern application<br/>partial"]
...
| C and Lua level construction | Fill: Light source | partial | The initialized lit oil lamp plus the shared oil-lamp/brass-lantern source fuel breakpoints, saveable deadline state, ordered generic timer dispatch, exact and overdue expiration, surviving-lantern identity, radius-three mobile illumination, and ordinary command activation/extinguishing have direct zero-bridge witnesses. Threshold warning text, magic lamps, potions of oil, candles, the candelabrum, artifact light, other cleanup/reschedule variants, inactive cached-level timing, and a sealed stratum remain open. |
