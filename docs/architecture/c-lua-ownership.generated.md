...
flowchart LR
    ...
    n_inert_monster_potion_impact["Inert potion impact against monsters<br/>partial"]
    ...
    n_generic_swallowed_throw --> n_inert_monster_potion_impact
    ...
    n_inert_monster_potion_impact --> n_rng_core
    n_inert_monster_potion_impact --> n_thrown_object_detachment
    n_inert_monster_potion_impact --> n_object_stack_merging
    n_inert_monster_potion_impact --> n_turn_scheduler
    n_inert_monster_potion_impact --> n_tty_display
