...
| Hero, monster, and global-turn scheduler | partial | js/allmain.js<br/>js/monmove.js | fastforward.turn<br/>fastforward.ranger-turn<br/>scheduler.default-replay-gap<br/>seeded role replay modules | Samurai and all five represented Rogue carriers have public bridge-free actor-rich witnesses; Priest, broader unseen actor/terrain branches, and a sealed gate remain open. |
