...
| C and Lua level construction | partial | js/mklev.js<br/>js/weight.js<br/>js/dungeon.js<br/>js/lua_des.js | fastforward.mineralize<br/>seeded room-fill compatibility paths | The ordinary-room orchestration now owns descendant-first fill, Amulet spawn/difficulty, monster/web, traps, Rogue skip, furniture/statue/bonus/chest/graffiti, random-object rejoin, grave burial, and final object/container weight under direct witnesses. Many special-level operations, legacy seeded room-fill compatibility branches, incomplete monster/trap/special-object constructors, dynamic and unseen Lua variants, and a sealed gate remain open. |
