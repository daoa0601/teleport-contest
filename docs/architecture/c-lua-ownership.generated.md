...
| Object and level-position timer queue and callbacks | partial | js/object_timers.js<br/>js/allmain.js<br/>js/mklev.js<br/>js/egg.js<br/>js/glob.js<br/>js/figurine.js<br/>js/figurine_timer.js<br/>js/object_data.js<br/>js/monster_data.js<br/>js/weight.js<br/>js/light.js<br/>js/cmd.js<br/>js/mondeath.js<br/>js/monworn.js<br/>js/object_knowledge.js<br/>js/u_init.js | none | The live queue owns saveable per-object and level-position timers, one monotonic id domain, source deadline ordering, newest-first equal-deadline ordering, claim-before-callback semantics, all seven enumerated object callback kinds, oil-lamp and brass-lantern exact/overdue burn state, manual cancellation with unused-time restoration, mobile illumination, the visible floor HATCH_EGG constructor/callback/lifecycle, the ordinary non-ice floor SHRINK_GLOB constructor/exact/catch-up/deletion lifecycle, and the ordinary hero-inventory FIG_TRANSFORM attachment/familiar/presentation/deletion lifecycle, plus the ordinary MELT_ICE_AWAY core, its pre-death trap normalization, and its resumable boulder sink/fill/burial and splash-wake continuation. Enumerated callback reachability is not complete carrier coverage. Inventory, monster-inventory, and owned-egg HATCH_EGG branches; taming, pack and carrier prose, dragon handling, and broader hatch placement/extinction variants; ice, contained, inventory, monster-inventory, buried, migrating, active-eating, encumbrance, and melding SHRINK_GLOB branches; floor and monster-inventory FIG_TRANSFORM, blocked-location retry, special locomotion, named/invisible/hiding/mimic/minion/shapechanger/weaponed familiar forms, unique/extinct limits, liquid death, manual application, and timer removal/reattachment breadth; burn warning presentation; potion/candle/candelabrum/artifact BURN_OBJECT variants; complex-pet and pet-genocide life-saving recovery; shapechanging/special-death and hero/unsafe-monster/drawbridge continuations; timer coordinate remapping and move/split/relink semantics; explicit terrain-mutation cancellation; exact pre-registry save tie reconstruction; inactive cached-level timers and catch-up; spot-time queries; complete inventory/worn corpse effects; and a sealed gate remain open. |
| Visible floor egg construction and hatching | partial | js/mklev.js<br/>js/object_timers.js<br/>js/allmain.js<br/>js/egg.js<br/>js/monster_data.js<br/>js/weight.js | none | Fresh typed eggs and the visible, unowned floor-stack carrier are source-shaped but the subsystem is partial. Hero inventory, monster inventory, owned eggs and taming, male-parentage RNG, dragon special handling, blind/hidden carrier prose, broader placement failure and extinction-during-batch behavior, timer preservation across corpsenm mutation, moved/split/relinked eggs, inactive cached-level catch-up, and a sealed stratum remain open. |
| Ordinary floor glob construction and shrinking | partial | js/mklev.js<br/>js/object_data.js<br/>js/object_timers.js<br/>js/allmain.js<br/>js/glob.js<br/>js/weight.js | none | Initialized globs and the ordinary non-ice floor carrier are source-shaped but the subsystem is partial. Ice and buried-under-ice cadence, hero/monster inventory, nested containers and recursive weight, active eating, encumbrance feedback, migration and burial deletion, worn cleanup, glob absorption and timer averaging, save relocation, inactive-level variants beyond the direct overdue arithmetic witness, and a sealed stratum remain open. |
| Ordinary carried figurine transformation | partial | js/u_init.js<br/>js/cmd.js<br/>js/figurine_timer.js<br/>js/object_timers.js<br/>js/allmain.js<br/>js/figurine.js<br/>js/mklev.js | none | Cursed hero-inventory attachment and the ordinary walking, weaponless, nonshifting, nonminion familiar carrier are source-shaped but the subsystem is partial. Floor and monster-inventory callbacks, blocked-location rnd(5000) retry, named forms, alternate locomotion prose, invisibility, mimics, hiding, minions, shapechangers, immediate pet weapon setup, unique/extinct birth limits, liquid death, manual figurine application, timer removal on inventory exit, all inventory insertion paths, and a sealed stratum remain open. |
