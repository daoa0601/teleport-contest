...
| Object and level-position timer queue and callbacks | partial | js/object_timers.js<br/>js/allmain.js<br/>js/mklev.js<br/>js/egg.js<br/>js/glob.js<br/>js/object_data.js<br/>js/monster_data.js<br/>js/weight.js<br/>js/light.js<br/>js/cmd.js<br/>js/mondeath.js<br/>js/monworn.js<br/>js/object_knowledge.js<br/>js/u_init.js | none | The live queue owns saveable per-object and level-position timers, one monotonic id domain, source deadline ordering, newest-first equal-deadline ordering, claim-before-callback semantics, six object callback kinds, oil-lamp and brass-lantern exact/overdue burn state, manual cancellation with unused-time restoration, mobile illumination, the visible floor HATCH_EGG constructor/callback/lifecycle, and the ordinary non-ice floor SHRINK_GLOB constructor/exact/catch-up/deletion lifecycle, plus the ordinary MELT_ICE_AWAY core, its pre-death trap normalization, and its resumable boulder sink/fill/burial and splash-wake continuation. The boulder-occupant branch now owns m_in_air survival, successful visible/unseen pre-detach life-saving, ordinary visible/unseen genocide-defeated life-saving followed by common death, simple tame-pet wary_dog survival, ordinary detachment, object/furniture mimic reveal and blocker repair after actor removal, M_AP_MONSTER preservation, inventory release, named and stacked corpse creation, corpse chance, G_NOCORPSE, and burial before splash. Inventory, monster-inventory, and owned-egg HATCH_EGG branches; taming, pack and carrier prose, dragon handling, and broader hatch placement/extinction variants; ice, contained, inventory, monster-inventory, buried, migrating, active-eating, encumbrance, and melding SHRINK_GLOB branches; FIG_TRANSFORM; burn warning presentation; potion/candle/candelabrum/artifact BURN_OBJECT variants; complex-pet and pet-genocide life-saving recovery; shapechanging/special-death and hero/unsafe-monster/drawbridge continuations; timer coordinate remapping and move/split/relink semantics; explicit terrain-mutation cancellation; exact pre-registry save tie reconstruction; inactive cached-level timers and catch-up; spot-time queries; complete inventory/worn corpse effects; and a sealed gate remain open. |
