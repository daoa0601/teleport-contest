...
| Live monster inventory acquisition and pet release | partial | js/monster_inventory.js<br/>js/cmd.js<br/>js/monmove.js | none | Unicorn gem acceptance, ordinary pet pickup/release, exact-square covetous artifact pickup, bullwhip inventory snatch, and clone-Wizard fake-Amulet linkage now use the common source-shaped boundaries. Stack merging and the generic swallowed-throw transaction, including supported lamp snuffing and surviving physical weapons, are tracked separately. Swallowed consuming objects and engulfer-death continuations, other thrown or kicked catches, shopkeeper projectile snatches, quest-leader retention, monster container rummaging, polymorph transfers, knowledge loss, non-swallowed light snuffing and candle burn, equipment continuation, migration persistence, and a sealed stratum remain open. |
| Generic swallowed throw contact and acquisition | partial | js/swallowed_throw.js<br/>js/cmd.js<br/>js/weapon_damage.js<br/>js/skills.js<br/>js/attrib.js<br/>js/monster_inventory.js<br/>js/object_merge.js<br/>js/figurine_timer.js<br/>js/light.js<br/>js/object_timers.js<br/>js/senses.js<br/>js/vision.js | throw.swallowed-weapon-unsupported | The non-worn, paid, generic non-consuming object path is live from selector and direction through split/free ownership, slip and hit-roll cadence, wake/contact prose, LOST_THROWN-to-LOST_STOLEN repair, carrying effects, timer replacement, minvent insertion, and compatible-stack absorption. Lit oil lamps, brass lanterns, and magic lamps additionally own the sighted/blind mpickobj message gate, link-before-snuff ordering, BURN_OBJECT cancellation, unused-fuel restoration, and mobile-light invalidation. Ordinary guaranteed-survivor hard-material non-ammo weapons and weapon-tools now own physical damage, Strength and skill bonuses, training, Dexterity exercise, wake/presentation, and acquisition. Ammo, missiles, launchers, silver and target-specific modifiers, axes, poison, artifacts, passives, peaceful/pet/worm carriers, wielded or returning weapons, shop state, gems, gold, food and taming, potions, eggs/pies/venom, boulders and iron balls, attached or worn objects, unsupported burning objects and artifact lights, low-stamina drops, timed stack splitting, engulfer death/expulsion/corpse/pickup continuation, complete naming variants, and a sealed stratum remain open. |
| Physical weapon damage dice, enchantment, erosion, and Strength | partial | js/weapon_damage.js<br/>js/swallowed_throw.js<br/>js/cmd.js | none | The ordinary physical damage table, enchantment, erosion, and Strength bonus core are shared, and the swallowed guaranteed-survivor caller composes live skill damage and training. Target-specific blessed, silver, wooden, artifact-light, shade, thick-hide, axe, poison, and special-monster modifiers are deliberately excluded; melee and other projectile callers still retain partial duplicated ownership, and no sealed stratum has run. |
