...
| Role/race inventory, attributes, skills, and starting pet | partial | js/u_init.js<br/>js/allmain.js<br/>js/options.js<br/>js/skills.js<br/>js/insight.js<br/>js/cmd.js | fastforward.post-mklev | Role/race construction now owns substitutions, racial knowledge, Orc compensation, universal discover-mode wishing, role-money order, and the pauper/nudist contract. Hidden starting gold/carry boost, reroll and blind/deaf strata, cross-role pet state beyond pauper saddle suppression, and a sealed stratified gate remain open. |
